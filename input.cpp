...
bool MouseWentDown(Uint8 button) {
	return (!(g_PrevMouseButtons & SDL_BUTTON(button)) &&
...
bool MousePressed(Uint8 button) { return g_MouseButtons & SDL_BUTTON(button); }

bool RightMouseWentDown() { return false; }

bool ShouldClose() { return g_Events & SDL_QUIT; }
