// This is the interface of the renderer. If you want to build a new backend
// (for example Apple Metal) then you have to implement against this interface.
...
enum DrawMode { DRAW_MODE_SOLID, DRAW_MODE_WIREFRAME, DRAW_MODE_LINES };
